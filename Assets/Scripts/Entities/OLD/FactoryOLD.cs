...
public sealed class FactoryOLD : BaseEntityOLD
{
    //    //  Internal objects
    //    //  ----------------
    ...
    public Action<UnitOLD> OnUnitBuilt;
    public Action<FactoryOLD> OnFactoryBuilt;
    ...
    //        return m_unitPrefabs[unitIndex].GetComponent<UnitOLD>().UnitData;
    //    }
    ...
    //        bool isFlyingUnit = unitPrefab.GetComponent<UnitOLD>().UnitData.isFlying;
    ...
    //        UnitOLD newUnit = unitInst.GetComponent<UnitOLD>();
    //        newUnit.Init(Team);
    ...
    //        return m_factoryPrefabs[factoryIndex].GetComponent<FactoryOLD>().GetFactoryData;
    //    }
    ...
    //        return true;
    //    }
    //    public FactoryOLD StartBuildFactory(int factoryIndex, Vector3 buildPos)
    //    {
    //        if (IsFactoryIndexValid(factoryIndex) == false)
    //            return null;
    ...
    //        FactoryOLD newFactory = factoryInst.GetComponent<FactoryOLD>();
